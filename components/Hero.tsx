          ...
          <SwiperSlide key={slide.id}>
            <div className="relative h-full slide bg-black">
              ...
              <div className="relative z-10 text-white h-full flex flex-col justify-center container">
                ...
                <p className="max-w-[540px] mt-0 lg:text-xl">{slide.acf.description}</p>
                <Link className="px-6 py-3 ring-1 ring-white block w-max uppercase text-sm tracking-widest mt-6" href={`/places/${slide.slug}`}>Explore it now!</Link>
              </div>
            </div>
          </SwiperSlide>
        ))}
